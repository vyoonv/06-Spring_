...
GRANT CONNECT, RESOURCE TO spring_jyh;

ALTER USER spring_jyh DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;
...
UPDATE MEMBER SET 
MEMBER_PW = '$2a$10$Oxuf9yqYuiza9lfRfVlvrO7t3scbM2WrE79wlNbfgL1Q4QzNSheei'
WHERE MEMBER_NO = 1; 
